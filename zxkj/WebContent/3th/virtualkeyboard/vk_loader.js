 ...
 * Keyboard loader
 * 
 * This software is protected by patent No.2009611147 issued on 20.02.2009 by
 * Russian Federal Service for Intellectual Property Patents and Trademarks.
 * 
 * @author Ilya Lebedev
 * @copyright 2006-2011 Ilya Lebedev <ilya@lebedev.net>
 * @version $Rev: 777 $
 * @lastchange $Author: wingedfox $ $Date: 2011-06-17 21:17:48 +0400 (Пт., 17
 *             июня 2011) $
 */
if (!window.VirtualKeyboard) {
	...
	(function() {
		var i = (function(_) {
			var c = document.getElementsByTagName('script'), C = new RegExp(
					'^(.*/|)(' + _ + ')([#?]|$)');
			for (var l = 0, e = c.length; l < e; l++) {
				...
				if (v) {
					...
					if (V[0] && V[0].href)
						return V[0].href + v[1];
					return (document.location.href.match(/(.*[\/\\])/)[0] + v[1])
							.replace(/^\/+/, "");
				}
			}
			return null
			...
			if (document.body) {
				...
				document
						.write("<scr" + "ipt type=\"text/javascript\" src=\""
								+ i + 'extensions/scriptqueue.js' + "\"></scr"
								+ "ipt>");
			}
		}
	})();
