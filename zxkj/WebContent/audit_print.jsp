...
<body>
	<form id="formAudit" action="" method="post">
		<header id="title" style="min-width:900px;width:100%;">提现打印</header>
		...
		<div class="lefttitle" style="color:white;background:blue;">操作</div>
			<ul style="line-height:30px;text-align:center;">
				<li>提现审核</li>
				<li style="background:gray;">提现打印</li>
				<li>历史提现</li>
				<li>付款记录</li>
			</ul>
		</div>
		<div class="right" style="width:600px;height:100%;float:left;border-left:1px solid red;">
