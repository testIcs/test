   ...
   <div style="width:900px;padding-left:10px;">
	...
	<legend>查&nbsp;&nbsp;询</legend>
	   <form id="searchForm" action="">
	     	支付时间从:<input type="text" id="payStartDate" style="width: 80px;" />
	     	到:<input type="text" id="payEndDate" style="width: 80px;" />
...
<script type="text/javascript" src="../script/payFlowRecord_success.js"></script>
</body>
</html>