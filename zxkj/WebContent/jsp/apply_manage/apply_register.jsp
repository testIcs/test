    ...
    <div class="content">
        ...
        <div class="rightmain">
			<div class="idcard-block">
                ...
                <div class="idcard-area"><img src="../css/images/pic2.jpg" width="600" height="320" /></div>
            </div>
            <div class="submit">
            	<a href="/zxkj/apply/toRateconfirm.do"><input style="width:150px; height:50px; font-size:30px;" type="button" value="提  交" /></a>
            	<a href="/zxkj/home/toApplyPage.do"><input style="width:150px; height:50px; font-size:30px;" type="button" value="返  回" /></a>
            </div>
        </div>
    </div>
    <div class="footer">
