...
<body>
   ...
   <div class="modal" id="modify_success_form">
			...
			<table style="margin-left: 20px;">
				<tr>
					<td>
						...
						<input id="userId_success" type="hidden">
					</td>				
				</tr>	
				<tr>
					<td >业务流水号:</td>
	...
	<div class="modal" id="modify_close_form">
		<a class="close" data-dismiss="modal"></a>
	    <h1>支付关闭</h1>
		<form id="project_type_form" class="reg-form customForm">
			<table style="margin-left: 20px;">
				<tr>
					<td>
						<input id="id_close" type="hidden"/>						
						<input id="userId_close" type="hidden">
					</td>				
				</tr>
				<tr>
					<td >业务流水号:</td>
					<td>
						<input type="text" id="businessFlowNo_close" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td >支付状态:</td>
					<td>
						<select id="payStatus_close">						
							<option value="3">支付关闭</option>						
						</select>
					</td>
				</tr>	
				<tr>
				...
				<tr>
					<td colspan="2">
						<input id="savePayFlowStatusBtn" onclick="savePayFlowStatus('close');" type="button" class="save" value="保 存" />
						<input id="cancelPayFlowStatusBtn" onclick="cancelPayFlowStatus();" type="button" class="cancel" value="取 消" />
					</td>				
				</tr>
			</table>
...
<script type="text/javascript" src="../script/payFlowRecord_fail.js"></script>
</body>
</html>