!function(f){
	...
	n.prototype={
		...
		show:function(){
			...
			&&
			(
					f("body").addClass("modal-open"),
					this.isShown=!0,
					this.escape(),
					this.backdrop(function(){
						var g=f.support.transition
						&&
						...
						g
						?
						e.$element.one(f.support.transition.end,function(){
	...
	enforceFocus:function(){
		...
		f(document).on(
				"focusin.modal",
				function(f){
					e.$element[0]!==f.target
					&&
					!e.$element.has(f.target).length
					&&
					e.$element.focus()
				}
		)
	...
	backdrop:function(e){
		...
		if(this.isShown&&this.options.backdrop){
			...
			!this.isShown&&this.$backdrop?(
					...
					this.$backdrop.one(
						f.support.transition.end,
						f.proxy(this.removeBackdrop,this)
					)
					:
					this.removeBackdrop()
			):e&&e()
